 ...
 */
 ...
 [_MAIN] = LAYOUT_ortho_5x15(
   ...
   KC_LSFT,         KC_SCLN,  KC_Q,    KC_J,    KC_K,    KC_X,       KC_KP_7, KC_KP_8,   KC_KP_9,    KC_B,     KC_M,    KC_W,    KC_V,    KC_Z,     KC_RSFT,
   _______,         KC_CAPS, KC_LGUI, KC_LALT, LOWER,   KC_SPC,     KC_LGUI, KC_KP_0,   KC_PPLS,    KC_BSPC,  RAISE,   KC_RALT, KC_RGUI, _______,   _______ 
  ),
 ...
 [_LOWER] = LAYOUT_ortho_5x15(
    ...
    LCTL(KC_SLSH), LCTL(KC_A),       KC_LBRC,        KC_LCBR,      KC_LPRN,    KC_MINS,    _______, _______, _______,  _______,    KC_RPRN,  KC_RCBR,  KC_RBRC, _______, _______, 
  ...
  [_ADJUST] = LAYOUT_ortho_5x15(
    _______,  PLOVER,     TO(_MAIN), _______,  _______,   _______,  UG_TOGG,  _______, _______, _______,    _______, _______, ST_GEM,   ST_BOLT,   QK_BOOT, 
